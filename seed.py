...
async def seed():
    ...
    async with async_session() as db:
        ...
        print("  Descuento MP: 20%")
        print("  Oblea discapacidad: GRATUITO")
        print("  Frentista: GRATUITO (solo en su cuadra)")
        print("  Veterano Malvinas: GRATUITO")
        print()
        print("HORARIOS:")
        print("  Lun-Vie: 7-21hs ($700/h autos, $300/h motos)")
        print("  Sábados: 7-14hs ($700/h autos, $300/h motos)")
        print("  Nocturno: 22-5hs en zona Balcarce/Güemes/Alvarado")
